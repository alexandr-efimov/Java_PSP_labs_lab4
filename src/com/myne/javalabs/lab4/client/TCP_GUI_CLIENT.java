package com.myne.javalabs.lab4.client;
...
public class TCP_GUI_CLIENT implements Runnable {
	...
	public final static TCP_GUI_CLIENT tcpObj = new TCP_GUI_CLIENT();
	public final static String END_CHAT_SESSION = new Character((char) 0).toString(); // Indicates
																						// the
